...
print("plotting performance sweep homoogeneous_independent_gaussian...")
plot_performance_sweep.plot(ax2,'homogeneous_independent_gaussian','local')
print("plotting performance sweep homoogeneous_identical_binary...")
...
fig.savefig(os.path.join(PLOT_DIR,'alt_hom_regulation_performance_sweep_composite_hom.pdf'))
fig.savefig(os.path.join(PLOT_DIR,'alt_hom_regulation_performance_sweep_composite_hom.png'),dpi=300)
