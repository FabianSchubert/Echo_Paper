...
import ESN_code.plotting.plot_hom_regulation_r_a as r_a
import ESN_code.plotting.plot_hom_regulation_specrad as specrad
...
fig.savefig(os.path.join(PLOT_DIR,'hom_regulation_composite.pdf'))
fig.savefig(os.path.join(PLOT_DIR,'hom_regulation_composite.png'),dpi=1000)
