...
fig.savefig(os.path.join(PLOT_DIR,'hom_regulation_performance_sweep_composite_het.pdf'))
fig.savefig(os.path.join(PLOT_DIR,'hom_regulation_performance_sweep_composite_het.png'),dpi=1000)
